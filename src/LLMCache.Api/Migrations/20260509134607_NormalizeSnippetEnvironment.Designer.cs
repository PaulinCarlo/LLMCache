...
namespace LLMCache.Api.Migrations
{
    ...
    [Migration("20260509134607_NormalizeSnippetEnvironment")]
    partial class NormalizeSnippetEnvironment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LLMCache.Api.Models.CodeType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LLMCache.Api.Models.SnippetEnvironment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("BuildTool")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("LLMCache.Api.Models.Snippet", b =>
                {
                    b.HasOne("LLMCache.Api.Models.SnippetEnvironment", "Environment")
                        .WithMany("Snippets")
            ...
            modelBuilder.Entity("LLMCache.Api.Models.SnippetEnvironment", b =>
                {
                    b.HasOne("LLMCache.Api.Models.CodeType", "CodeType")
                        .WithMany("SnippetEnvironments")
            ...
            modelBuilder.Entity("LLMCache.Api.Models.CodeType", b =>
                {
                    b.Navigation("SnippetEnvironments");
                });
